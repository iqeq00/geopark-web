        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                layui.use("upload", function (o) {
                    var r = l.uploadImage || {};
                    o.render({
                        url: r.url, method: r.type, headers: r.headers, data: r.data, elem: e(n).find("input")[0], done: function (e) {
                            200 == e.status ? (e.result = e.result || {}, v.call(t, "img", {
                                src: e.result.path,
                                alt: e.result.originalName
                            }, a)) : i.msg(e.msg || "上传失败")
                        }
                    })
                })
