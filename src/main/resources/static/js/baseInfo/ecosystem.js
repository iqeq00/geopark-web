...
layui.use(['config', 'lichee', 'jquery', 'layer', 'table', 'form', 'laydate'], function () {
    ...
    var tableInfo = table.render({
        ...
        cols: [[
            ...
            // {field: 'id', title: 'ID'},
            {field: 'parkId', align: 'center', sort: true, title: '公园编号',width: 100},
            {field: 'type', align: 'center', sort: true, title: '地貌类型',width: 100},
            {field: 'averagetempera', align: 'center', sort: true, title: '年平均气温',width: 110},
            {field: 'toptempera', align: 'center', sort: true, title: '年最高气温',width: 110},
            {field: 'bottomtempera', align: 'center', sort: true, title: '年最低气温',width: 110},
            {field: 'averagerain', align: 'center', sort: true, title: '年平均降水',width: 110},
            {field: 'plantcover', align: 'center', sort: true, title: '植被绿地',width: 100},
            {field: 'animal', align: 'center', sort: true, title: '珍稀动物',width: 100},
            {field: 'plant', align: 'center', sort: true, title: '珍稀植物',width: 100},
            {field: 'water', align: 'center', sort: true, title: '水资源概况',width: 110},
            {field: 'plantcover', align: 'center', sort: true, title: '植被绿地',width: 100},
